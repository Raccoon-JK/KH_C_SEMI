...
<link href="${pageContext.request.contextPath}/resources/css/snow.css" rel="stylesheet" type="text/css">
<style>
    i {
        position: fixed;
        height: 3px;
...
<body>
    ...
    <script src="${pageContext.request.contextPath}/views/common/snowing.js"></script>

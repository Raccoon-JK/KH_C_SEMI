...
<link rel="stylesheet" href="${pageContext.request.contextPath}/views/common/css/rain.css" type="text/css">
...
<body>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/views/common/js/rain.js" ></script>
